...
**Next step:** validate the local workflow first and describe the deployed workload you need through the [Cloud pilot contact](https://folderbase.ai/#access). Include record count, typical document size, writers, and recovery needs. Managed pricing and signup are not launched.
