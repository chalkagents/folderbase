...
**Core 0.7.0 status:** local version behavior is implemented, but `version ... --json` is experimental and is not part of CLI JSON v1. Pin the exact Core release if you automate it.
