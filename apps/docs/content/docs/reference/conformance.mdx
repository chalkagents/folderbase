...
`folderbase.template-expansion@0.1.0` has eight implementation-neutral
black-box cases. They prove typed parser errors, bounded stdin, read-only
planning, exact-root approval binding, no-clobber application, idempotent
replay, portable path handling, and handoff to reorganization. Candidate
