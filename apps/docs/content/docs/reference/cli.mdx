...
Exact-folder first-share evidence has its own stable optional contract; see the
[Folder Scope evidence reference](/docs/reference/folder-scope-evidence).
Exact retained-Version reconstruction uses its own stable optional contract;
