...
description: Install Folderbase Core 0.6.1 through npx, Homebrew, crates.io, or a verified native binary.
---
...
The formula installs the matching verified binary from the immutable Core 0.6.1 release.
...
Download the matching artifact from the [Core 0.6.1 GitHub release](https://github.com/chalkagents/folderbase/releases/tag/v0.6.1), verify it with the published `SHA256SUMS`, mark it executable, and place it on your `PATH`.
