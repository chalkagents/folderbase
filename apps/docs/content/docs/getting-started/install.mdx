...
description: Install Folderbase Core 0.5 through npx, Homebrew, crates.io, or a verified native binary.
---
...
The formula installs the matching verified binary from the immutable Core 0.5 release.
