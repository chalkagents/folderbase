...
description: Install Folderbase Core 0.7.2 through npx, Homebrew, crates.io, or a verified native binary.
---
...
Download the matching artifact from the [Core 0.7.2 GitHub release](https://github.com/chalkagents/folderbase/releases/tag/v0.7.2), verify it with the published `SHA256SUMS`, mark it executable, and place it on your `PATH`.
