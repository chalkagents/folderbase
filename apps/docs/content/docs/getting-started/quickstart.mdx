...
Do not manually initialize multiple accidental boundaries. Core 0.7.1 includes an experimental [migration workflow](/docs/guides/migrate) that can analyze the folder and produce a reviewable structure plan. Its JSON is not part of CLI JSON v1 yet.
