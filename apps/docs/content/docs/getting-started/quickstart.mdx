...
This filters the CLI's workspace view. It does not restrict an agent process's
filesystem permissions. See [agent access boundaries](/docs/guides/agents#access-boundaries)
before giving an agent direct access to the folder.
