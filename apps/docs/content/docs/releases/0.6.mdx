...
```bash
npx --yes @folderbase/cli@0.6.0 --version
...
[GitHub release](https://github.com/chalkagents/folderbase/releases/tag/v0.6.0).
...
Core 0.6 retains Compatibility Contract v1, CLI JSON v1, native root-manifest
