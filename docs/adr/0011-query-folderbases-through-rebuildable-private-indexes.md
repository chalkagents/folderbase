...
new definitions or commands in Folderbase CLI JSON v1. Once argv selects
`query` or `index`, parser syntax failures are inside this rule: missing roots
or `--json`, unknown flags, and unknown subcommands use
